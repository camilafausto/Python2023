...
# Questão 3 - Escreva um programa que solicite ao usuário um número inteiro e 
...
# Questão 5 - Escreva um programa que solicite ao usuário uma idade e 
# verifique se ela está entre 18 e 30 anos (inclusive).

idade = int(input("Digite a sua idade: "));

if idade >= 18 and idade <= 30:
    print("Sua Idade está correta.");
else:
    print(" Sua Idade não está correta.");


# Questão 6 - Escreva um programa que solicite ao usuário três números inteiros e 
...
if (n1 > 0) or (n2 > 0) or (n3 > 0):
    ...
    print(" Os números informados são negativos ou zero.");


# Questão 7 - Escreva um programa que solicite ao usuário uma letra e 
...
# Questão 8 - Escreva um programa que solicite ao usuário um número inteiro e
...
# Questão 9 - Escreva um programa que solicite ao usuário três números e 
...
# Questão 10 - Escreva um programa que solicite ao usuário um número inteiro e 
